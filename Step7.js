...
const issuerSecretKey = 'SA3HFYXWLXS6MXCB42LG2WABTHBZG7BLQFZRSQS243AWRBVTOSUBFTP5';
...
const distributorSecretKey = 'SCOCIP6HQJCE3EAQ72FVJSAQDMQKMKMKCXRZKOXYVRX3HQOWKWJAOYR2';
...
const investorPublicKey = 'GDFXCTCHNQTBK6444M7JKG5PERTSA4TBBJHYT7QDWC66YXJZ43R5FNFE';
...
(async function paymentDis() {
    ...
    const transaction = new StellarSdk.TransactionBuilder(account, { fee })
      ...
      .addOperation(StellarSdk.Operation.payment({
        ...
        asset: new StellarSdk.Asset('VMC', issuerPublicKey),
